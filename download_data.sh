...
if [[ "$CURDIR" =~ "DyGMA/data" ]]
then
	echo "please run this script under the root dir of the project, eg directory DyGMA"
...
python $RAMSDIR/merge.py --indir $RAMSDIR/data --outdir $RAMSDIR/data_final
rm -rf ./RAMS_1.0
...
# python $SCRIPT/deepeventmine_to_DyGMA.py --indir $MLEEDIR/raw --outdir $MLEEDIR/
